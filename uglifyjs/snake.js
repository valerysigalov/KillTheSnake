...
SNAKE.Board = (function() {
    ...
    return function(inputConfig) {
        ...
        var playBoard = this,
            ...
            replayBtn, restBtn, resmBtn, pauseBtn, volBtn, videoPanel,
        ...
        function createBoardElements() {
            ...
            if (constants.PLATFORM === "ios") {
                videoPanel = document.createElement("video");
                videoPanel.src = "res/video/tutorial.mp4";
            }
            ...
            if (constants.PLATFORM === "ios") {
                phoneScreen.appendChild(videoPanel);
            }
        ...
        playBoard.setupPhoneScreen = function () {
            ...
            if (constants.PLATFORM === "ios") {
                videoPanel.style.left = "0px";
                videoPanel.style.top = "0px";
                videoPanel.style.width = cWidth + "px";
                videoPanel.style.height = cHeight + "px";
            }
