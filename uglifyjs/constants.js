...
if (constants.PLATFORM === "ios") {
    ...
    if (constants.CONTROL === "swipe") {
        ...
        constants.LEAD_FASTEST_SNAKE_KILLER = '4';
        constants.LEAD_GAME_PROGRESS = '5';
    }
    ...
    constants.LINK = "<br><br><span style=\"text-decoration:underline\">Check out video tutorial</span>";
    ...
    if (constants.CONTROL === "swipe") {
        ...
        constants.LINK = "<br><br><a href=https://goo.gl/60eKWB style=\"color:#ea4335\">Check out video tutorial</a>";
